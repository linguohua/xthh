export namespace proto {
	...
	export namespace casino {
		...
		class packet_bind_phone_req implements Ipacket_bind_phone_req {
			public phone: string;
			public code: string;
			constructor(properties?: casino.Ipacket_bind_phone_req);
			public static encode(message: packet_bind_phone_req): ByteBuffer;
			public static decode(reader: Uint8Array|ByteBuffer): packet_bind_phone_req;
		}

		interface Ipacket_bind_phone_ack {
			ret: number;
			phone?: string;
			auth_time?: Long;
		}

		class packet_bind_phone_ack implements Ipacket_bind_phone_ack {
			public ret: number;
			public phone: string;
